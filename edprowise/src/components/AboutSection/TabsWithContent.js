...
const tabs = [
    ...
    id: 'tab1', label: 'Digital Services - Advance ERP', content: (
      <>
        <div className={`category-items col-lg-4 col-md-12 col-12 grid-web s3`}>
          <div className="wpo-courses-item category-itemm">
            <div className="wpo-courses-text">
              <p className="category-text font-family-web ">Our robust suite of digital services is designed to bring schools into the modern era of education management. We provide custom school applications for principals, teachers, students, and parents, along with professionally designed websites that enhance a school’s digital presence.</p>
            </div>
          </div>
        </div>
        ...
        <div className={`category-items col-lg-4 col-md-12 col-12 grid-web s5`}>
          <div className="wpo-courses-item category-itemm">
            <div className="wpo-courses-text">
              <p className="category-text font-family-web ">Additional digital solutions include online payment systems, digital exam result generation, library and admission management, attendance tracking, SMS and WhatsApp communication services, MIS reporting, and more—all aimed at simplifying operations and enhancing productivity.</p>
            </div>
          </div>
        </div>
      </>
...

  {
    id: 'tab3', label: 'Our Expertise', content: (<>
      <p style={{ color: "white" }}>Our team brings together years of experience in education management, procurement, technology, and logistics, allowing us to deliver high-quality solutions with precision and professionalism. Our goal is to simplify school operations, reduce costs, improve service quality, and enable educators to focus on what matters most — teaching and nurturing students.</p>
    </>)
  },

  {
    id: 'tab4', label: 'Relationship Management', content: (<>
      <p style={{ color: "white" }}>At EdProwise, we don’t just offer services we build long-term partnerships. Our dedicated relationship managers work closely with each school to understand their needs, provide tailored solutions, and ensure a smooth, responsive service experience. Your success is our priority.</p>
    </>)
  }
];
...
const procurementPoints = [
  ...
  {
    title: 'Low Cost',
    description: 'Leveraging bulk discounts through aggregated purchasing power.'
  },
  {
  ...
  },
  {
    ...
    description: 'Schools can place, track, and manage orders seamlessly via our platform or app.'
  },
  {
    title: 'Bulk Discount Advantage',
    description: 'Enjoy corporate-level discounts as we consolidate demand across multiple institutions.'
  }
];
    ...
    <>
      <section className="wpo-courses-section-s2 section-padding pt-2 pb-1">
        <div className="container">
          ...
          <div className="tab-buttons-scroll">
            {tabs.map((tab) => (
              <button
                ...
                style={{
                  backgroundColor: activeTab === tab.id ? tabBackgrounds[tab.id] : '#ffffff',
          ...
          <div ref={contentRef} className="row-web wpo-courses-wrap tab-content-box"
            style={{
              backgroundColor: activeTab ? tabBackgrounds[activeTab] : 'transparent',
              maxHeight: '0',
            }}
          >
            {activeContent}
