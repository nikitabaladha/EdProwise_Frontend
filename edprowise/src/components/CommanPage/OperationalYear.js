...
import CreateOperationalAcademicYear from './CreateOperationalAcademicYear';
const Dropdown = ({ onSelect }) => {
    ...
    const handleSubmit = () => {
        if (selectedAcademicYear) {
            ...
            navigate('/school-dashboard/operational-service/send-sms/greeting-sms');
        } else {
