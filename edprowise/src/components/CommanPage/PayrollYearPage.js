...
import CreatePayrollAcademicYearModal from './CreatePayrollAcademicYearModal'
const Dropdown = ({ onSelect }) => {
    ...
    const handleSubmit = () => {
        if (selectedAcademicYear) {
            ...
            if(role === "School")
            navigate('/school-dashboard/payroll-module/employer/employee-registration');
        else if(role==="Employee")
           navigate('/employee-dashboard/payroll-module/employee/update-details');
        } else {
        ...
        <>
            <div style={styles.container}>
                <div className="position-absolute top-0 end-0 d-flex gap-2 p-3">
                    <button
                        className={`${role === 'Employee' ? "d-none" : ""} btn btn-dark`}
            ...
            <CreatePayrollAcademicYearModal
                isOpen={isModalOpen}
