  ...
  return (
    ...
    <section className="wpo-blog-section section-padding p-0" id="blog">
              ...
              <div className="category-wrapper">
                <div className="category-nav">
                  ...
                  >
                    ...
                    <button id="gallerySection" className={`category-item-btn   ${activeTab === "gallerySection" ? "active" : ""}`}
                      onClick={() => showTab("gallerySection")}> Gallery</button>

                    <button id="edprowiseSection" className={`category-item-btn   ${activeTab === "edprowiseSection" ? "active" : ""}`}
                      onClick={() => showTab("edprowiseSection")}>EdProwise Talks</button>

                    <button id="studentSection" className={`category-item-btn   ${activeTab === "studentSection" ? "active" : ""}`}
                      onClick={() => showTab("studentSection")}>Student Zone</button>

                    <button id="educatorSection" className={`category-item-btn  ${activeTab === "educatorSection" ? "active" : ""}`}
                      onClick={() => showTab("educatorSection")} >Educator Zone</button>
        ...
        <div className="wpo-blog-items">
          ...
          <div className={`show-tab ${activeTab === "edprowiseSection" ? "active" : ""}`} id="edprowiseSection">
          <EdprowiseTalkSection />
          </div>

          <div className={`show-tab ${activeTab === "studentSection" ? "active" : ""}`} id="studentSection">
          <StudentZoneSection />
          </div>

          <div className={`show-tab ${activeTab === "educatorSection" ? "active" : ""}`} id="educatorSection">
          <EducatorZoneSection />
          </div>
        </div>
      </section>
