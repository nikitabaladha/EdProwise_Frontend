...
const OrderReceiveSellerTemplate = () => {
  const [formData, setFormData] = useState({
        ...
        useEffect(() => {
            ...
            const fetchEmailTemplate = async () => {
              try {
                const response = await getAPI("/get-order-receive-templates", {}, true);
          ...
          const handleSubmit = async (e) => {
            ...
            try {
              const response = await postAPI("/post-order-receive-templates", formData, true);
...
export default OrderReceiveSellerTemplate;