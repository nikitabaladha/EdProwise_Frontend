...
const QuoteProposalSentToSchoolEmailTemplate = () => {
  const [formData, setFormData] = useState({
          mailFrom: "",
          subject: "Quote Proposal Receive", 
          content: "",
        });
        ...
        useEffect(() => {
            ...
            const fetchEmailTemplate = async () => {
              try {
                const response = await getAPI("/get-quote-proposal-templates", {}, true);
          ...
          const handleSubmit = async (e) => {
            ...
            try {
              const response = await postAPI("/post-quote-proposal-templates", formData, true);
                        ...
                        <div className="col-md-12">
                          <div className="mb-3">
                            ...
                            <input
                              ...
                              defaultValue="Quote Proposal Receive"
                              required
                            />
                          </div>
                        </div>
...
export default QuoteProposalSentToSchoolEmailTemplate;