...
const SchoolRequestForQuoteEmail = () => {
  const [formData, setFormData] = useState({
        ...
        useEffect(() => {
            ...
            const fetchEmailTemplate = async () => {
              try {
                const response = await getAPI("/get-request-quote-templates", {}, true);
          ...
          const handleSubmit = async (e) => {
            ...
            try {
              const response = await postAPI("/post-request-quote-templates", formData, true);
...
export default SchoolRequestForQuoteEmail;