...
const UserIdUpdateEmailTamplate = () => {
    const [formData, setFormData] = useState({
        mailFrom: "",
        subject: "UserId Update", 
        content: "",
      });
      ...
      useEffect(() => {
          ...
          const fetchEmailTemplate = async () => {
            try {
              const response = await getAPI("/get-userId-templates", {}, true);
        ...
        const handleSubmit = async (e) => {
          ...
          try {
            const response = await postAPI("/post-userId-templates", formData, true);
...
export default UserIdUpdateEmailTamplate;