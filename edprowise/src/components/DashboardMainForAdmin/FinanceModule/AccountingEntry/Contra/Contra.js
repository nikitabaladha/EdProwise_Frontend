...
//                         <td key={index} className="text-start align-content-center border border-dark p-2" >
//                             Cash Account
//                         </td>
//                         <td className="text-end align-content-center border border-dark p-2" >
//                             <input
...
//                             <input
//                                 type="text"
//                                 className="form-control payroll-table-body fw-bold payroll-input-border text-end"
//                                 required
//                             />
//                         </td>
//                         <td className="text-end align-content-center border border-dark p-2" >
...
const Contra = () => {
    ...
    const [rows, setRows] = useState(selectedEntry === "Bank Transfer" ? [{}, {}] : [{}]);
    const addRow = () => {
        setRows([...rows, {}]);
    };

    const removeRow = (index) => {
        const minRows = selectedEntry === "Bank Transfer" ? 2 : 1;
    ...
    const handleEntryChange = (e) => {
        ...
        // Reset rows based on selected entry type
        setRows(entryType === "Bank Transfer" ? [{}, {}] : [{}]);
    };
    const bankTransferRows = selectedEntry === "Bank Transfer" ?
        [...rows, {}] :
        rows;
    const lessType = [
        { value: 'TDS', label: 'TDS' },
                                                        ...
                                                        <>
                                                            <tr key={index} className='payroll-table-body' >
                                                                <td className="text-start align-content-center border border-dark p-2" >
                                                                    <CreatableSelect
                                                                        isClearable
                                                                        name={`bankDeposited-${index}`}
                                                                        // options={emailOptions}
                                                                        placeholder="Select Bank Reference"
                                                            ...
                                                            <tr className='payroll-table-body' >
                                                                ...
                                                                <td className="text-start align-content-center border border-dark p-2" >
                                                                    <CreatableSelect
                                                                        ...
                                                                        className="email-select payroll-table-body text-nowrap rounded payroll-input-border"
                                                                    />
                                                                </td>
                                                                <td className="text-end align-content-center border border-dark p-2" >
                                                                    <input
                                                    ...
                                                    {rows.map((row, index) => (
                                                        <>
                                                            <tr key={index} className='payroll-table-body' >
                                                                ...
                                                                {rows.length > (selectedEntry === "Bank Transfer" ? 2 : 1) && (
                                                                    <td className="text-center align-content-center border border-dark p-2">
                                                                        <button
                                                                            type="button"
                                                                            className="btn btn-danger btn-sm"
