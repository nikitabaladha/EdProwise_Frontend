...
const ContraTable = () => {
    ...
    const navigateToAdd = (event) => {
        ...
        navigate(`/admin-dashboard/finance-module/account-entry/contra/contra-form`);
    };

    const navigateToView = (event) => {
        event.preventDefault();
        navigate(`/admin-dashboard/finance-module/account-entry/contra/view-contra-form`);
    };

    const navigateToUpdate = (event) => {
        event.preventDefault();
        navigate(`/admin-dashboard/finance-module/account-entry/contra/update-contra-form`);
    };
