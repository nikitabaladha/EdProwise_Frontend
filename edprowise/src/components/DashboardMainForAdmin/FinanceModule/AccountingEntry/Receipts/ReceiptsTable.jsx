...
const ReceiptsTable = () => {
    const navigate = useNavigate();
        const navigateToAdd = (event) => {
            ...
            navigate(`/admin-dashboard/finance-module/account-entry/receipts/receipts-entry`);
        };
    
        const navigateToView = (event) => {
            event.preventDefault();
            navigate(`/admin-dashboard/finance-module/account-entry/receipts/view-receipts-entry`);
        };
    
        const navigateToUpdate = (event) => {
            event.preventDefault();
            navigate(`/admin-dashboard/finance-module/account-entry/receipts/update-receipts-entry`);
        };
