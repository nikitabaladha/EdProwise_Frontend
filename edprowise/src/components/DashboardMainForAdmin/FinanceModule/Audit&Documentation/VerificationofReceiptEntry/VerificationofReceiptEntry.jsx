...
const VerificationofReceiptEntry = () => {
                            ...
                            <div className="card-body custom-heading-padding">
                                ...
                                <div className="container">
                                    <div className="card-header d-flex justify-content-between align-items-center gap-1">
                                        <h4 className=" payroll-title text-center mb-0 flex-grow-1">Receipt Entry Ledger</h4>
                                    </div>
                                </div>
...
export default VerificationofReceiptEntry