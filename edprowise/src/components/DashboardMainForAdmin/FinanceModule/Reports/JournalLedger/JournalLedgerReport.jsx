                        ...
                        <div className="card-body custom-heading-padding">
                            ...
                            <div className="container">
                                <div className="card-header d-flex justify-content-between align-items-center gap-1">
                                    <h4 className=" payroll-title text-center mb-0 flex-grow-1">Journal Ledger</h4>
                            ...
                            <form onSubmit="">
                                <div className="row salary-slip-box m-0 mb-2">
                                    ...
                                    <div className="col-md-6 align-content-center" style={{borderRight:"2px solid"}}>
                                        <p className='text-dark payroll-box-text my-2'>
                                            <strong> Entry Date :</strong>
                                        </p>
                                        <p className='text-dark d-flex payroll-box-text my-2'>
                                            <div className='col-md-6'>
                                    ...
                                    <div className="row m-0 payroll-box-line" />
                                    <div className="col-md-6 align-content-center" style={{borderRight:"2px solid"}}>
                                        <p className='text-dark payroll-box-text my-2'>
                                            <select
                                                id="selectAccountingEntry"
                                                name="selectAccountingEntry"
                                                className="form-control"
                                                required
                                    ...
                                    <div className="col-md-6 align-content-center" style={{borderRight:"2px solid"}}>
                                        <p className='text-dark payroll-box-text my-2'>
                                            ...
                                            >
                                                <option value="">Select BS/P&L Ledger</option>
                                                <option value="Balance Sheet">Balance Sheet</option>
                                                <option value="P&L Ledger">P&L Ledger</option>
                                            </select>
                                        </p>
                                    </div>
                                    ...
                                    <table className="table text-dark border border-dark mb-1">
                                        ...
                                        <tbody>
                                            <tr className='payroll-table-body' >
                                                <td rowSpan={2} className="text-start align-content-center border border-dark text-nowrap p-2" >
                                                    20-08-2025
                                                </td>
