...
const SalarySlip = () => {
    ...
    return (
        <div className="container my-4 text-dark" style={{ padding: 16 }}>
            <div className="row payroll-box-line"  />
                    ...
                    <table className="table border border-dark text-dark mb-4" >
                        ...
                        <tbody>
                            ...
                            <tr className="payroll-table-body it-declaration-section-bg" >
                                <td colSpan={3} className="text-center border border-dark fw-bold p-2" >
                                    Net Salary
                                </td>
                ...
                <div className="row text-dark">
                    ...
                    <div className="col-12 text-start">
                        <p className="text-dark">
                            <strong>P.S. This is a system generated document and hence no signature is required.</strong>
                        </p>
