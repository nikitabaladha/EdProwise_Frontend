                        ...
                        <table className="table align-middle mb-0 table-hover table-centered text-center">
                          ...
                          <tbody>
                            <tr className='payroll-table-body' >
                              ...
                              <td>
                                <label htmlFor="basicSalary" className="form-label fw-bold" >
                            ...
                            <tr className='payroll-table-body'>
                              ...
                              <td>
                                <label htmlFor="pfContribution" className="form-label fw-bold" >
                            ...
                            <tr className='payroll-table-body'>
                              ...
                              <td>
                                <label htmlFor="totalAnnualGross" className="form-label fw-bold" >
                            ...
                            <tr >
                              ...
                              <td>
                                <label htmlFor="gratuity" className="form-label fw-bold" >
                            ...
                            <tr className='payroll-table-body'>
                              ...
                              <td>
                                <label htmlFor="annualCostToInstitution" className="form-label fw-bold" >
