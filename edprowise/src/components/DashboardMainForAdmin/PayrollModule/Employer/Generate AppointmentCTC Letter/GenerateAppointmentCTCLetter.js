                                    ...
                                    <>
                                        <div id="receipt-content" className="box-border p-3">
                                            ...
                                            <div className="table-responsive px-lg-6 px-md-5 py-3">
                                                <table className="table mb-0 text-dark border border-dark" style={{ border: "1px solid black", color: "black", placeContent: "center" }}>
                                                    <thead>
                                                        <tr className="payroll-table-header">
                                                            <th className="text-center border border-dark align-content-center p-2" style={{ border: "1px solid black" }}>
                                                                Components
                                                            </th>
                                                            <th className="text-center border border-dark align-content-center p-2" style={{ border: "1px solid black" }}>
                                                                Annual Amount
                                            ...
                                            <div className="row py-3">
                                                <div className="col-12">
                                                    <p className='text-dark'>
                                                      <strong>Gratuity :</strong> Employees are entitled to payment of Gratuity of 15 days of Basic Pay, for every year of completed service once they complete 5 years in the company, as per the Payment of Gratuity Act 1972. In the event the employee ceases to be in employment before completion of five years, this benefit will be forfeited.
                                                    </p>
                                                    <div className="row border border-dark" />
                                                    <p className='text-dark'>
                                                       <strong> Provident Fund :</strong> You will be governed by the provisions of The Employees Provident Fund & Misc. Provisions Act, 1952.
                                                    </p>
                                                  <div className="row border border-dark" />
                                                    <p className='text-dark'>
