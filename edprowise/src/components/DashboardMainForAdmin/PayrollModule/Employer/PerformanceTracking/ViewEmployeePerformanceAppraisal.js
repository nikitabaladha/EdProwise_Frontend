                ...
                <table className="table border border-dark text-dark mb-2">
                  <thead>
                    <tr className="payroll-table-header">
                      <th className="text-center border border-dark p-2">Feedback</th>
                      <th className="text-center border border-dark p-2">Rating</th>
                    </tr>
                  </thead>
                  <tbody>
                    {feedbackCategories.map((category) => (
                      <tr className="payroll-table-body" key={category}>
                        <td className="align-middle p-2 border border-dark">{category}</td>
                            ...
                            {[1, 2, 3, 4, 5].map((star) => (
                              <span
                                ...
                                style={{
                                  ...
                                  fontSize: '2rem',
                                  color:
                                    star <= (hoverRatings[category] || ratings[category] || 0)
                                      ? '#ffc107'
                                      : '#e4e5e9',
                                  marginRight: '0.5rem',
