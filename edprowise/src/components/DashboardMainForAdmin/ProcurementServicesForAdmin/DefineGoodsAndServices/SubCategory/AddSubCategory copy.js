...
const AddSubCategory = () => {
  ...
  const handleRowChange = (index, field, value) => {
    ...
    // If the category is being set, clear the edprowiseMargin
    if (field === "categoryId" && value) {
      updatedRows[index].edprowiseMargin = ""; // Clear margin when selecting a category
    }
                        ...
                        <>
                          ...
                          <div className="col-md-2">
                            ...
                            <input
                              type="text"
                              className="form-control"
                              value={row.selectedEdprowiseMargin} // Assuming this is the margin fetched from the selected category
                              readOnly
                            />
                          </div>
                        </>
