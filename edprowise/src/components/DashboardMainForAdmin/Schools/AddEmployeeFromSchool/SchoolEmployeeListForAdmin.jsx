...
const SchoolEmployeeListForAdmin = () => {
  ...
  const navigateToRegisterEmployee = (event) => {
    ...
    navigate(`/admin-dashboard/schools/view-school/school-employee/add-employee`, {
      state: { schoolId }
    });
  };
  ...
  const navigateToRegisterInfo = (event, employee) => {
    event.preventDefault();
    navigate("/admin-dashboard/schools/view-school/school-employee/view-employee-details", {
      state: { employee }
    });
  };
  ...
  const navigateToUpdateRegisterInfo = (event, employee) => {
    event.preventDefault();
    navigate("/admin-dashboard/schools/view-school/school-employee/update-employee", {
      state: { employee }
    });
  };
...
export default SchoolEmployeeListForAdmin