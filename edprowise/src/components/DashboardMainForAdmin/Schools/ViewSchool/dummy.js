...
// import postAPI from "../../../../api/postAPI"; // Assuming you have a postAPI utility
// import putAPI from "../../../../api/putAPI"; // Assuming you have a putAPI utility
...
//     try {
//       const response = await postAPI(`/school-roles`, newRole, true);
...
//       setError("Error adding role. Please try again.");
//     }
//   };
...
//     try {
//       const response = await putAPI(`/school-roles/${id}`, updatedRole, true);
//       if (!response.hasError && response.data && response.data.data) {
//         const updatedRoles = schoolRoles.map((role) =>
//           role.id === id ? { ...role, name: editInputValue.trim() } : role
//         );
...
//     try {
//       const response = await getAPI(`/school-roles/${schoolId}`, {}, true);
//       if (
//         !response.hasError &&
//         response.data &&
//         Array.isArray(response.data.data)
...
//                                 >
//                                   <iconify
//                                     iconName="solar:trash-bin"
// minimalistic-2-broken"
