                    ...
                    <div className="col-xl-12">
                        <div className="card">
                            <div className="card-header d-flex justify-content-between align-items-center gap-1">
                                <h4 className="card-title flex-grow-1">All Request Demo List</h4>
                                    ...
                                    <tbody>
                                        {currentRequests.map((request, index) => (
                                            <tr key={index}>
                                                ...
                                                <td>{request.name}</td>
                                                <td>
  {request.schoolName.length > 35 ? `${request.schoolName.slice(0, 35)}...` : request.schoolName}
</td>
                                                
                                                <td>{request.email}</td>
                                                <td>{request.phone}</td>
                                                <td>
                                                    {new Date(request.demoDateTime).toLocaleString("en-US", {
                                                        year: "numeric",
                                                        day: "2-digit",
                                                        month: "2-digit",  
                                                        hour: "2-digit",
