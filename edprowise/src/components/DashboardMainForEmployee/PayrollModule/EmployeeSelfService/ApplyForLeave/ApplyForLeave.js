...
//                           Entity
//                         </label>
//                         <select id="entity" name="entity" className="form-control" required>
...
//                         </label>
//                         <select id="leaveYear" name="leaveYear" className="form-control" required>
                                        ...
                                        <div className="col-md-12">
                                            <div className="mb-2">
                                                ...
                                                >
                                                    ...
                                                    <option value="2025-26">2025-26</option>
                                                    <option value="2026-27">2026-27</option>
                                                    <option value="2025-26">2027-28</option>
