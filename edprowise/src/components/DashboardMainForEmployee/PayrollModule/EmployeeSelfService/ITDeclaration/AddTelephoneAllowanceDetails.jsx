...
// const AddTelephoneAllowanceDetails = () => {
...
//       const response = await postAPI(`/create-telephone-allowance/${employeeId}`, formDataToSend, 
//         { 'Content-Type': 'multipart/form-data' }, true
//       );

//       toast.success(response.message || 'Telephone Allowance record added successfully');
      
//     } catch (err) {
//       toast.error(err.message || 'Failed to add Telephone Allowance record');
//     } finally {
//       setSending(false);
//     }
//   };
...
// export default AddTelephoneAllowanceDetails;
...
const AddTelephoneAllowanceDetails = () => {
  ...
  try {
    ...
    if (!response.hasError && response.data?.data) {
      ...
      const ltaComponent = components.find(c => c.ctcComponentName === 'Telephone Allowance');
