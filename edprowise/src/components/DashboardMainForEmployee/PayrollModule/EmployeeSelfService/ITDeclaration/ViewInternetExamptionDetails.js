...
const ViewInternetExamptionDetails = () => {
  const navigate = useNavigate();
  const { state } = useLocation();
  const internetDetails = state?.internet;
  ...
  useEffect(() => {
    if (internetDetails) {
      setFormData({
        employeeName: internetDetails.employeeName || '',
        billNumber: internetDetails.billNumber || '',
        billDate: internetDetails.billDate || '',
        supplierName: internetDetails.supplierName || '',
        vendorName: internetDetails.vendorName || '',
        gstNumber: internetDetails.gstNumber || '',
        grossAmount: internetDetails.grossAmount || '',
        billFile: internetDetails.billFile || null,
      });
    }
  }, [internetDetails]);
...
export default ViewInternetExamptionDetails;