...
const LetterAndDocuments = () => {
    ...
    const navigateToAdd = (event) => {
        ...
        navigate(`/admin-dashboard/payroll-module/employee-services/letter-documents/add-letter-documents`);
    };

    const navigateToView = (event) => {
        event.preventDefault();
        navigate(`/admin-dashboard/payroll-module/employee-services/letter-documents/view-letter-documents`);
    };

    const navigateToUpdate = (event) => {
        event.preventDefault();
        navigate(`/admin-dashboard/payroll-module/employee-services/letter-documents/update-letter-documents`);
    };
                        ...
                        <div className="card-body custom-heading-padding">
                            <div className="container">
                                <div className="card-header d-flex  align-items-center ">
                                    <h4 className=" payroll-title text-center mb-0 flex-grow-1">Letter And Documents</h4>
                                    <Link
