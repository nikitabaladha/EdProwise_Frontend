...
const SalaryPayoutApprovalTable = () => {
  const navigate = useNavigate();

  const navigateToView = (event) => {
    event.preventDefault();
    navigate(
      `/principal-dashboard/approval/salary-payout/view-salary-payout-details`
    );
  };
  return (
                ...
                <table className="table align-middle mb-0 table-hover table-centered text-center">
                  <thead className="bg-light-subtle">
                    <tr className="payroll-table-header">
                      ...
                      <th className="text-nowrap">Total Employee</th>
                      <th className="text-nowrap">Total Amount</th>
                      <th className="text-nowrap">Pay date</th>
...
export default SalaryPayoutApprovalTable