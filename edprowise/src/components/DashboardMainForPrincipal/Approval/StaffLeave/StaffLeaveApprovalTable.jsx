...
const StaffLeaveApprovalTable = () => {
  const navigate = useNavigate();
  
    const navigateToView = (event) => {
      event.preventDefault();
      navigate(
        `/principal-dashboard/approval/staff-leave/view-staff-leave-details`
      );
    };
  return (
                ...
                <table className="table align-middle mb-0 table-hover table-centered text-center">
                  <thead className="bg-light-subtle">
                    <tr className="payroll-table-header">
                      ...
                      <th className="text-nowrap">Leave From</th>
                      <th className="text-nowrap">Leave To</th>
                      <th className="text-nowrap">Total Days</th>
...
export default StaffLeaveApprovalTable