...
const StaffResignationApprovalTable = () => {
  const navigate = useNavigate();

  const navigateToView = (event) => {
    event.preventDefault();
    navigate(
      `/principal-dashboard/approval/staff-resignation/view-staff-resignation-details`
    );
  };
  return (
                ...
                <table className="table align-middle mb-0 table-hover table-centered text-center">
                  <thead className="bg-light-subtle">
                    <tr className="payroll-table-header">
                      ...
                      <th className="text-nowrap">Last Date</th>
...
export default StaffResignationApprovalTable;
