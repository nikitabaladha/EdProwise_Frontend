...
const ViewStudentAdmissionApprovalDetails = () => {
              ...
              <div className="container">
                <div className="card-header mb-2 d-flex flex-wrap align-items-center">
                  <h4 className="card-title flex-grow-1 text-center">
                    View Student Admisstion Details
                  </h4>
                  <button
                    type="button"
                  ...
                  <div className="col-md-4">
                    <div className="mb-3">
                      <label htmlFor="className" className="form-label">
                        Propose Class <span className="text-danger">*</span>
                      </label>
                      <input
                        type="text"
                        id="className"
...
export default ViewStudentAdmissionApprovalDetails