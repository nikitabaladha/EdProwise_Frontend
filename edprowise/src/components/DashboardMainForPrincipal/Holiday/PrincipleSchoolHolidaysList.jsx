...
const PrincipleSchoolHolidaysList = () => {
  const navigate = useNavigate();

  const navigateToAdd = (event) => {
    event.preventDefault();
    navigate(`/principal-dashboard/holiday/add-holiday`);
  };

  const navigateToView = (event) => {
    event.preventDefault();
    navigate(`/principal-dashboard/holiday/view-holiday`);
  };

  const navigateToUpdate = (event) => {
    event.preventDefault();
    navigate(`/principal-dashboard/holiday/update-holiday`);
  };
...
export default PrincipleSchoolHolidaysList;
