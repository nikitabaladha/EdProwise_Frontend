...
const PrincipalNotices = () => {
      ...
      const navigateToAdd = (event) => {
        ...
        navigate(`/principal-dashboard/notes-notice/notices/add-notice`);
      };
    
      const navigateToView = (event) => {
        event.preventDefault();
        navigate(`/principal-dashboard/notes-notice/notices/view-notice`);
      };
    
      const navigateToUpdate = (event) => {
        event.preventDefault();
        navigate(`/principal-dashboard/notes-notice/notices/update-notice`);
      };
