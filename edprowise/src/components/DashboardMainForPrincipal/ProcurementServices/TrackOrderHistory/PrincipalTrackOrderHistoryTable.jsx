...
const PrincipalTrackOrderHistoryTable = () => {
  ...
  const navigateToViewOrder = (event, order, orderNumber, enquiryNumber) => {
    ...
    navigate(
      `/principal-dashboard/procurement-services/track-order-history/view-order-history`,
      {
...
export default PrincipalTrackOrderHistoryTable;
