...
const PrincipalUpdateVisitingDetails = () => {
  return (
              ...
              <form>
                <div className="row">
                  ...
                  <div className="col-md-4">
                    <div className="mb-3">
                      <label htmlFor="studentName" className="form-label">
                        Visitor Number <span className="text-danger">*</span>
                      </label>
                      <input
                        type="text"
                        id="studentName"
                  ...
                  <div className="col-md-4">
                    ...
                    <div className="mb-3">
                      <label htmlFor="section" className="form-label">
                        Whom to Meet <span className="text-danger">*</span>
                      </label>
                      <input
                        type="text"
                        id="section"
                        ...
                        className="form-control"
                        required
                        placeholder="Enter Whome to Meet"
                      />
                    </div>
...
export default PrincipalUpdateVisitingDetails;