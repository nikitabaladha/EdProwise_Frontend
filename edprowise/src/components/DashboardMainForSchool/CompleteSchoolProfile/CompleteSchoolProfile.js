...
//                         </div>
//                       </th>
//                       {/* i want that if i tick on this check box at that time below below delivery address will be filled like School Address , below location filled same as above school location, below delivery land mark will be filled same like above land mark and below pin code will be filled same like above pin code   */}
//                     </div>
//                     <div className="row">
//                       <div className="mb-3">
