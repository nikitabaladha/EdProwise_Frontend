...
const BoardExamFeesList = () => {
  ...
  const navigateToAddNew = (event) => {
    ...
    navigate(`/school-dashboard/fees-module/admin-setting/board-fees/exam-fees-add`);
  };
                      ...
                      <tr key={fees._id}>
                        ...
                        <td>
                          <div className="d-flex gap-2">
                            <button
                              onClick={() =>
                                navigate("/school-dashboard/fees-module/admin-setting/board-fees/exam-fees-view", {
                                  state: { fees }
                                })
                              }
                            ...
                            <button
                              ...
                              onClick={() =>
                                navigate("/school-dashboard/fees-module/admin-setting/board-fees/exam-fees-update", {
                                  state: { fees }
                                })
                              }
                            >
...
export default BoardExamFeesList;