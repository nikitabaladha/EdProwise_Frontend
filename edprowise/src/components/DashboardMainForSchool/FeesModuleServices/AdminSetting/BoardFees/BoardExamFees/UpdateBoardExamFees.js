...
const UpdateBoardExamFees = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!existingFees?._id) {
      toast.error("No board exam fees ID found for updating");
      return;
    }
    ...
    try {
      const response = await putAPI(`/update-board-exam-fees/${existingFees._id}`, payload, {}, true);
      if (response.hasError) {
        toast.error(response.message || "Failed to update board exam fees.");
      } else {
        toast.success(response.message || "Board exam fees updated successfully.");
        navigate(-1);
      }
    } catch (err) {
        ...
        <div className="col-xl-12">
          <div className="card m-2">
            <div className="card-body">
              <h4 className="card-title text-center">Update Board Exam Fees</h4>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-4">
                      ...
                      <div className="d-flex flex-wrap">
                        {getClassById(entry.selectedClassId)?.sections.map((section) => (
                          <div key={section._id} className="form-check me-2">
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                updateEntry({ selectedSections: updatedSections });
                              }}
                              disabled
                            />
