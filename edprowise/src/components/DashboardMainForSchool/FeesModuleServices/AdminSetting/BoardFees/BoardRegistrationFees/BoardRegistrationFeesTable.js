...
const BoardRegistrationFeesList = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const feesRes = await getAPI(`/get-board-registration-fees/${schoolId}/${selectedYear}`, {}, true);
  ...
  const navigateToAddNew = (event) => {
    ...
    navigate(`/school-dashboard/fees-module/admin-setting/board-fees/registration-fees-add`);
  };
          ...
          <div className="col-xl-12">
            <div className="card">
              <div className="card-header d-flex justify-content-between align-items-center gap-1">
                <h4 className="card-title flex-grow-1">All Board Registration Fees</h4>
                <select
                      ...
                      <tr key={fees._id}>
                        ...
                        <td>
                          <div className="d-flex gap-2">
                            <button
                              onClick={() =>
                                navigate("/school-dashboard/fees-module/admin-setting/board-fees/registration-fees-view", {
                                  state: { fees }
                                })
                              }
                            ...
                            <button
                              ...
                              onClick={() =>
                                navigate("/school-dashboard/fees-module/admin-setting/board-fees/registration-fees-update", {
                                  state: { fees }
                                })
                              }
                            >
