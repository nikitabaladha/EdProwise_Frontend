              ...
              <table className="table align-middle mb-0 table-centered text-center">
                ...
                <tbody>
                  {currentRequests.length > 0 ? (
                    currentRequests.flatMap((classandsection, classIndex) =>
                      classandsection.sections.map((section, sectionIndex) => (
                        <tr key={`${classandsection._id || classIndex}-${sectionIndex}`}>
                          <td>
                            <div className="form-check ms-1">
                              <input
                                type="checkbox"
                                className="form-check-input"
                                id={`customCheck-${classIndex}-${sectionIndex}`}
                              />
                              <label
                                className="form-check-label"
                                htmlFor={`customCheck-${classIndex}-${sectionIndex}`}
                              >
                                &nbsp;
                              </label>
                            </div>
                          ...
                          <td>{getShiftName(section.shiftId) || 'N/A'}</td>
                          <td>
                            {sectionIndex === 1 ? (
