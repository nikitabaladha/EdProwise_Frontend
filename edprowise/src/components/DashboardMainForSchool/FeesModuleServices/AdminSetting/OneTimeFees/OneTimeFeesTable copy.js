                  ...
                  <tbody>
                    {currentItems.map((fee) => (
                      <tr key={fee._id}>
                        ...
                        <td>{fee.sectionIds?.map(id => sectionMap[id] || "N/A").join(", ") || "N/A"}</td>
                        <td>
                          ₹{Array.isArray(fee.installments)
                            ? fee.installments.reduce((sum, inst) =>
                              sum + (inst.fees?.reduce((subSum, f) => subSum + f.amount, 0) || 0), 0)
                            : 0}
                        </td>
                        ...
                        <td>
                          <div className="d-flex gap-2">
                            <button
                              onClick={() =>
                                navigate("/school-dashboard/fees-module/admin-setting/view-one-time-fees", {
                                  state: { structure: fee }
                                })
                              }
                            ...
                            <button
                              ...
                              onClick={() =>
                                navigate("/school-dashboard/fees-module/admin-setting/update-one-time-fees", {
                                  state: { structure: fee }
                                })
                              }
                            >
