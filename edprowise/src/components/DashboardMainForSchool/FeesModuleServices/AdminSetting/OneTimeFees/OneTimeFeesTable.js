...
const OneTimeFeesTable = () => {
  ...
  const navigateToAddNew = (event) => {
    ...
    navigate(`/school-dashboard/fees-module/admin-setting/fees-structure/one-time-fees-add`);
  };
                        ...
                        <tr key={`${fee._id}-${index}`}>
                          {index === 0 ? (
                            <>
                              ...
                              <td rowSpan={fee.oneTimeFees.length}>{classMap[fee.classId] || "N/A"}</td>
                              <td rowSpan={fee.oneTimeFees.length}>
                                {fee.sectionIds?.map(id => sectionMap[id] || "N/A").join(", ") || "N/A"}
                              </td>
                            </>
                          ) : null}
                          ...
                          {index === 0 ? (
                            <td rowSpan={fee.oneTimeFees.length}>
                              <div className="d-flex gap-2">
                                <button
                                  onClick={() =>
                                    navigate("/school-dashboard/fees-module/admin-setting/fees-structure/one-time-fees-view", {
                                      state: { structure: fee }
                                    })
                                  }
                                ...
                                <button
                                  ...
                                  onClick={() =>
                                    navigate("/school-dashboard/fees-module/admin-setting/fees-structure/one-time-fees-update", {
                                      state: { structure: fee }
                                    })
                                  }
                                >
