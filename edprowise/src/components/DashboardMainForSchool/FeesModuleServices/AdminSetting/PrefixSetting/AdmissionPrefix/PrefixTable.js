...
const SchoolPrefixes = () => {
  ...
  useEffect(() => {
    ...
    const fetchPrefixes = async () => {
      try {
        const response = await getAPI(`/get-admission-prefix/${schoolId}/year/${selectedYear}`);
  ...
  const navigateToAddNewPrefix = (e) => {
    e.preventDefault();
    navigate(`/school-dashboard/fees-module/admin-setting/prefix-setting/admission-prefix/add-prefix`);
  };
