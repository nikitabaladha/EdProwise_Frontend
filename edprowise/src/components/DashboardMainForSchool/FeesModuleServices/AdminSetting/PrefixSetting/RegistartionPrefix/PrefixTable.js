...
const SchoolPrefixes = () => {
  ...
  const navigateToAddNewPrefix = (e) => {
    e.preventDefault();
    navigate(`/school-dashboard/fees-module/admin-setting/prefix-setting/registartion-prefix/add-prefix`);
  };
          ...
          <div className="col-xl-12">
            <div className="card">
              <div className="card-header d-flex justify-content-between align-items-center gap-1">
                <h4 className="card-title flex-grow-1">Registartion Prefix </h4>
                {prefixes.length === 0 && (
                  <Link onClick={navigateToAddNewPrefix} className="btn btn-sm btn-primary">
                    Add Prefix
                  </Link>
                )}
