...
//                 {refund.refundType === "Registration Fee" ? "Registration No:" : "Admission No:"}
//               </td>
//               <td>
//                 {refund.refundType === "Registration Fee"
...
//                 ? feeType.refundAmount?.toFixed(2) || "0.00"
//                 : feeType.cancelledAmount?.toFixed(2) || "0.00"}
//             </td>
//             <td className="text-center">{feeType.balance?.toFixed(2) || "0.00"}</td>
//           </tr>
//         ))
//       ) : (
//         <tr>
