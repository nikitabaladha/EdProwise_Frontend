...
// const BoardExamFeePaymentTable = () => {
...
//         setDeleteType("boardexamfeepayment");
//     };
...
//             try {
//                 const response = await getAPI(`/get-board-exam-fee-payments/${schoolId}/${selectedYear}`);
...
//     const navigateToBoardExam = (event) => {
//         event.preventDefault();
//         navigate(`/school-dashboard/fees-module/fees-receipts/board-exam/fees`);
//     };
...
//                 : "",
//             "Receipt Number": student.receiptNumberBef || "",
...
//         XLSX.utils.book_append_sheet(workbook, worksheet, "BoardExamFees");

//         XLSX.writeFile(workbook, `Board_Exam_Fee_Payments_${selectedYear}.xlsx`);
//     };
...
//                     <Link
//                         onClick={(event) => navigateToBoardExam(event)}
...
//                                                                                 onClick={(event) => {
//                                                                                     navigateToFeesReceipt(event, student,student.receiptNumberBef);
//                                                                                     setOpenDropdownId(null);
//                                                                                 }}
//                                                                             >
//                                                                                 Download {student.receiptNumberBef}
//                                                                             </button>
...
// export default BoardExamFeePaymentTable;
...
const BoardExamFeePaymentTable = () => {
    ...
    const handleSelectChange = (selected, action) => {
        console.log("handleSelectChange:", { selected, action }); 
    ...
    const filteredStudents = studentData.filter(student => {
        ...
        const matchesClass = selectedClasses.length === 0 || selectedClasses.some(c => c.value === (student.classId?.toString() || ""));
        const matchesSection = selectedSections.length === 0 || selectedSections.some(s => s.value === (student.sectionId?.toString() || ""));
