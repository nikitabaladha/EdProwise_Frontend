        ...
        <div className="row mb-3 text-black">
          ...
          <div className="col-md-6">
            <div className="d-flex mb-2">
              ...
              <span>{new Date(currentStudent.applicationDate).toLocaleDateString('en-GB')}</span>
            </div>
            <div className="d-flex mb-2">
              <span className="fw-bold me-2" style={{ minWidth: '120px' }}>Academic Year:</span>
              <span>
                {(() => {
                  const year = new Date(currentStudent.applicationDate).getFullYear();
                  return `${year}-${year + 1}`;
                })()}
              </span>
            </div>
          ...
          <table className="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td className="text-center fw-bold">{currentStudent.finalAmount}</td>
              </tr>
        ...
        <div className="row mb-3 text-black">
          <div className="col-md-6">
            <div className="d-flex mb-2">
              ...
              <span className="text-capitalize">{currentStudent.paymentMode}</span>
            </div>
          ...
          <div className="col-md-6">
            <div className="p-3 text-center" style={{ height: '100%' }}>
              ...
              <div className="mt-4 pt-3" style={{ borderTop: '1px solid #dee2e6' }}>
                <p className="mb-0 fw-bold">{currentStudent.name || "School Administrator"}</p>
