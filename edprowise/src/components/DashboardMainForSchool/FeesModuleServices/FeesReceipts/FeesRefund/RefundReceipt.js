            ...
            <tbody>
              {refundTypeName === 'School Fees' && refund?.feeTypeRefunds?.length > 0 ? (
                ...
                <tr>
                  ...
                  <td className="text-center">{refund?.paidAmount.toFixed(2) || '0'}</td>
                  <td className="text-center">{refund?.balance.toFixed(2) || '0'}</td>
                  <td className="text-center">{refund?.refundAmount.toFixed(2) || '0'}</td>
                </tr>
              )}
              <tr className="table-active">
                ...
                <td className="text-center fw-bold">{refund?.refundAmount.toFixed(2) || '0'}</td>
              </tr>
            </tbody>
          </table>
        </div>
