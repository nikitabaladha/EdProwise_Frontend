...
//     console.log("isCancelledOrReturned:", isCancelledOrReturned);
//   }, [student, isCancelledOrReturned]);
...
//       const receiptId = receiptDetails[0]?._id;
//       if (!receiptId) {
//         toast.error("Cannot cancel receipt: Invalid or missing receipt ID.");
//         console.error("Receipt ID is undefined:", receiptDetails[0]);
//         return;
//       }

//       try {
//         const response = await getAPI(`/get-school-fees-status/${receiptId}`, true);
