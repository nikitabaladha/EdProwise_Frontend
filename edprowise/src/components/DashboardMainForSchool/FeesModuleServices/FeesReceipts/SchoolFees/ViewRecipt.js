...
//     const { studentAdmissionNumber, receiptNumber } = receiptDetails[0];
//     if (!schoolId || !studentAdmissionNumber || !receiptNumber) {
//       toast.error("Cannot get data: Missing school ID, admission number, or receipt number.");
//       console.error("Missing parameters:", { schoolId, studentAdmissionNumber, receiptNumber });
//       return;
//     }

//     try {
//       const encodedAdmissionNumber = encodeURIComponent(studentAdmissionNumber);
//       const encodedReceiptNumber = encodeURIComponent(receiptNumber);
//       const response = await getAPI(`/get-school-fees-statusbyadm/${schoolId}/${encodedAdmissionNumber}/${encodedReceiptNumber}`, true);
...
//           chequeSpecificReason: response.data.schoolFees.chequeSpecificReason,
//           additionalComment: response.data.schoolFees.additionalComment,
//           cancelledDate: response.data.schoolFees.cancelledDate,
//           paymentMode: response.data.schoolFees.paymentMode,
//         }));
...
//     const totalFineAmount = Number(receipt.fineAmount || 0); // Use receipt.fineAmount
//     const finePaid = Number(receipt.fineAmount || 0); // Use receipt.fineAmount
//     const excessAmount = Number(receipt.excessAmount || 0); // Use receipt.excessAmount
...
//               console.log("allFees:", allFees); // Debugging log
...
//                           console.log("allFees JSX:", allFees); // Debugging log
