...
const UpdateConcessionForm = () => {
  ...
  // Pre-fill form data when student data is available
  useEffect(() => {
    if (student) {
      setFormData({
  ...
  const handleSubmit = (e) => {
    ...
    // Add your update logic here (e.g., API call to update the student data)
  };
