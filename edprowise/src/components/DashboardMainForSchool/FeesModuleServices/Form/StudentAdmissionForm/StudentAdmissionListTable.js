    ...
    <>
      ...
      {showPaymentModal && (
        <PaymentModal
          ...
          sectionName={getSectionNameById(studentData.find(s => s._id === selectedAdmissionId)?.section)}
          parentContactNumber={studentData.find(s => s._id === selectedAdmissionId)?.parentContactNumber || ""}
        />
      )}
    </>
  );
