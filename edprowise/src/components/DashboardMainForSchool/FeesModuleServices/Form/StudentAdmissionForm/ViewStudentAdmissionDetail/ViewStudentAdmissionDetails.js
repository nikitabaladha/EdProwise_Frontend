                    ...
                    <div className="col-md-4 d-flex flex-column align-items-center">
                      <div className="border rounded d-flex justify-content-center align-items-center mb-2"
                        ...
                        {formData.studentPhoto ? (
                          ...
                          <div className="text-secondary">No Photo</div>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-4">
                        <div className="mb-3">
                          ...
                          {typeof formData.previousSchoolResult === 'string' && (
                            <div className="mt-2">
                              {renderFileViewButton(formData.previousSchoolResult, "Previous School Result")}
                            </div>
                          )}
                        </div>
                      </div>
                      <div className="col-md-4">
                        <div className="mb-3">
                          ...
                          {typeof formData.tcCertificate === 'string' && (
                            <div className="mt-2">
                              {renderFileViewButton(formData.tcCertificate, "TC Certificate")}
                            </div>
                          )}
                        </div>
                      </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-4">
                      <div className="mb-3">
                        ...
                        {typeof formData.proofOfResidence === 'string' && (
                          <div className="mt-2">
                            {renderFileViewButton(formData.proofOfResidence, "Proof of Residence")}
                          </div>
                        )}
                      </div>
                    </div>
                    <div className="col-md-4">
                      <div className="mb-3">
                        ...
                        {typeof formData.aadharPassportFile === 'string' && (
                          <div className="mt-2">
                            {renderFileViewButton(formData.aadharPassportFile, "Aadhar/Passport")}
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    {formData.studentCategory !== "General" && (
                      <div className="col-md-4">
                        <div className="mb-3">
                          ...
                          {typeof formData.castCertificate === 'string' && (
                            <div className="mt-2">
                              {renderFileViewButton(formData.castCertificate, "Caste Certificate")}
                            </div>
                          )}
                        </div>
                      </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-4">
                      <div className="mb-3">
                        ...
                        {typeof formData.idCardFile === 'string' && (
                          <div className="mt-2">
                            {renderFileViewButton(formData.idCardFile, "ID Card")}
                          </div>
                        )}
                      </div>
                    </div>
