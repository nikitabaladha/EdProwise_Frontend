...
export const generatePDFofficial = async (schoolId, student, getClassNameById,getSectionNameById, getShiftName) => {
  ...
  const mockstudentData = {
    ...
    masterDefineClass: (() => {
      ...
      section: (() => {
      try {
        const sectionName = getSectionNameById(student.section) || "N/A";
        return sectionName;
      } catch (error) {
        return "N/A";
      }
  ...
  try {
          ...
          <div class="pdf-row">
            ...
            <div class="pdf-col-3">
              <div class="pdf-field">
                ...
                <div class="pdf-value">${mockstudentData.section}</div>
              </div>
            </div>
          </div>
          <div class="pdf-field">
      ...
      <div class="pdf-container">
        ...
        <div class="pdf-section">
          ...
          <div class="pdf-row">
            <div class="pdf-col-4">
              <div class="pdf-field">
                <label class="pdf-label">Admission Fees</label>
                <div class="pdf-value">₹${mockstudentData.admissionFees}</div>
              </div>
            </div>
               <div class="pdf-col-4">
              <div class="pdf-field">
      ...
      <div class="pdf-row">
        ...
        <div class="pdf-col-3">
          <div class="pdf-field">
            ...
            <div class="pdf-value">${mockstudentData?.AdmissionNumber|| ""}</div>
          </div>
        </div>
      </div>
      <div class="pdf-row">
        ...
        <div class="pdf-col-3">
          <div class="pdf-field">
            ...
            <div class="pdf-value">${mockstudentData?.chequeNumber ? mockstudentData.chequeNumber : mockstudentData?.transactionNumber || ""}</div>
          </div>
        </div>
      </div>
    </div>
    ...
    pdf.save(`Student_Admission_${mockstudentData.firstName}_${mockstudentData.lastName}.pdf`);
