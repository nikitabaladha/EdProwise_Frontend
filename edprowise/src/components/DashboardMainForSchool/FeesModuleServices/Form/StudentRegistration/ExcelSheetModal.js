...
//       ['📌 Import Guidelines:'],
//       [
//         'Required Fields: firstName, lastName, dateOfBirth, age, nationality, gender, motherTongue, className, shift, currentAddress, country, state, city, pincode, studentCategory, parentalStatus, howReachUs, aadharPassportNumber, selectedFeeType, registrationFee, finalAmount, name, paymentMode.',
//       ],
//       [
//         'Conditional Fields: chequeNumber and bankName are required if paymentMode is Cheque. fatherName, fatherContactNo, fatherProfession are required unless parentalStatus is Single Mother. motherName, motherContactNo, motherProfession are required unless parentalStatus is Single Father. relationType, siblingName are required unless siblingInfoChecked is true.',
//       ],
//       [
//         'Optional Fields: middleName, parentContactNumber, bloodGroup, fatherQualification, motherQualification, previousSchoolName, addressOfPreviousSchool, previousSchoolBoard, concessionAmount.',
//       ],
//       [
//         'Formats: Dates must be YYYY-MM-DD. paymentMode must be Cash/Cheque/Online. nationality must be India/International/SAARC Countries. gender must be Male/Female. studentCategory must be General/OBC/ST/SC. parentalStatus must be Single Father/Single Mother/Parents. howReachUs must be Teacher/Advertisement/Student/Online Search/Others. bloodGroup must be AB-/AB+/O-/O+/B-/B+/A-/A+. relationType must be Brother/Sister when siblingInfoChecked is false, or empty/null when siblingInfoChecked is true.',
//       ],
      ...
      try {
        ...
        reader.onload = async (e) => {
          ...
          for (let index = 0; index < jsonData.length; index++) {
            ...
            // Validate concessionType when concessionAmount > 0
