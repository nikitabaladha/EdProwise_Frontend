export const validateBasicForm = (formData, toast) => {
    if (!formData) {
    ...
    const requiredFields = [
        ...
        { field: 'proofOfResidence', message: 'Please upload proof of residence' },
    ];
    ...
    if (!formData.aadharPassportFile) {
        toast.error('Please upload the Aadhaar/Passport file');
        return false;
    }
