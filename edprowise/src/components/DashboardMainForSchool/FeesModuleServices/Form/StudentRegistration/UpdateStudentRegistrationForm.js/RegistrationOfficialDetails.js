      ...
      <div id="receipt-content" className="border border-dark p-3">
        ...
        <div className="row text-dark">
          <div className="col-6">
            ...
            <p style={{ color: 'black' }}>
              <strong>Date of Payment:</strong>{new Date(student.registrationDate).toLocaleDateString('en-GB')}
            </p>
            <p style={{ color: 'black' }}>
              <strong>Transaction No./Cheque No.:</strong> {student.transactionNumber}
            </p>
          </div>
