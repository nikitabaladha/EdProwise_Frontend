...
export const generatePDF = async (formData, student, classes, shifts, existingFiles, schoolId) => {
  ...
  try {
    ...
    if (formData.studentPhoto || existingFiles?.studentPhoto) {
      if (typeof formData.studentPhoto === "string") {
        photoSrc = await getImageDataUrl(formData.studentPhoto);
        ...
        photoSrc = await getImageDataUrl(`${process.env.REACT_APP_API_URL_FOR_IMAGE}${existingFiles.studentPhoto}`);
      }
    }
      ...
      <div class="pdf-row">
        <div class="pdf-col-4">
          <div class="pdf-field">
            ...
            <div class="pdf-value">₹${mockFormData.registrationFee}</div>
          </div>
        </div>
        <div class="pdf-col-4">
          <div class="pdf-field">
      ...
      <div class="pdf-row">
        ...
        <div class="pdf-col-3">
          <div class="pdf-field">
            ...
            <div class="pdf-value">${student?.registrationNumber || ""}</div>
          </div>
        </div>
      </div>
      <div class="pdf-row">
...
`;
    ...
    pdf.save(`Student_Registration_${mockFormData.firstName}_${mockFormData.lastName}.pdf`);
