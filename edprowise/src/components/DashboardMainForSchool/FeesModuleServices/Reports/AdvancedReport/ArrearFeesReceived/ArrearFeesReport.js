...
//     { id: 'totalDue', label: 'Total Fees Received' },
...
const ArrearFeesReceivedReport = () => {
  ...
  //           feeTypes: Object.fromEntries(
  //             (refund.feeTypeRefunds || []).map(feeType => [
  //               feeType.feeType,
  //               {
  ...
  //             ])
  //           ),
  //           totalDue: Number(refund.cancelledAmount || 0).toFixed(2),
  //           totalPaid: Number(refund.cancelledAmount || 0).toFixed(2),
  //           totalConcession: Number(
  //             (refund.feeTypeRefunds || []).reduce(
      ...
      const refundRecords = res.data.data.flatMap(item =>
        (item.refundData || []).map(refund => {
          ...
          return {
            ...
            totalPaid: Number(totalRefundAmount - totalConcession).toFixed(2), // Net Collection = Total Fees Received - Fees Concession
