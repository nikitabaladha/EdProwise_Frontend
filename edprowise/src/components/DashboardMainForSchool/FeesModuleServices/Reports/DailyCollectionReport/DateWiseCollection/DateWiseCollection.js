...
//       setAcademicYearOptions(filterOptions.academicYearOptions || []);
...
//                       placeholder="Search by date or payment mode"
//                       value={searchTerm}
...
//                   <h2 className="payroll-title text-center mb-0 flex-grow-1">Datewise Collection Fees Report</h2>
//                 </div>
//               </div>
...
//                         groupedDataArray.flatMap(({ date, records }, groupIndex) =>
...
//                           <strong>{totals.totalPaidFee || 0}</strong>
//                         </td>
//                       </tr>
//                     </tfoot>
//                   </table>
...
// export default DateWiseFeesCollection ;
