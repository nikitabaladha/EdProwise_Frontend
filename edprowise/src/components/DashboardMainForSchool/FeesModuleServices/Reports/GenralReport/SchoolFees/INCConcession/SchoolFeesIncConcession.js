...
import { exportToExcel, exportToPDF } from './SchoolFeesReportIncConcessionexport';
import { fetchSchoolData } from '../../../../PdfUtlisReport';

const SchoolFeesReportIncConcession = () => {
  ...
  const nonNumericColumnsCount = 9; // Date to Receipt No.
                ...
                <div className="container">
                  <div className="card-header d-flex justify-content-between align-items-center gap-1">
                    <h2 className="payroll-title text-center mb-0 flex-grow-1">
                     School Fees Inc Concession Report 
                    </h2>
                  </div>
                </div>
...
export default SchoolFeesReportIncConcession;