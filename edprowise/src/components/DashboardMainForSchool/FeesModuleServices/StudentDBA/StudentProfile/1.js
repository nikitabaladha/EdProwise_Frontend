...
//     navigate(`/school-dashboard/fees-module/student-profile/view-admission-form`, {
//       state: { student },
//     });
//   };
...
//     event.preventDefault();
//     navigate(`/school-dashboard/fees-module/student-profile/update-admission-form`, {
//       state: { student },
//     });
//   };
...
//                         <td>
//                           <button
//                             className={`btn btn-sm ${student.TCStatus === 'Active' ? 'btn-success' : 'btn-danger'}`}
//                           >
//                             {student.TCStatus}
//                           </button>
//                         </td>
...
const StudentAdmissionProfile = () => {
  ...
  const handleStatusChange = async (studentId, newStatus) => {
    try {
      const response = await putAPI(`/update-tc-active-inactive-status/${studentId}`, { TCStatus: newStatus });
      if (!response.hasError) {
        setStudentData((prevData) =>
          prevData.map((student) =>
            student._id === studentId
              ? { ...student, TCStatus: newStatus, TCStatusDate: response.data.data.TCStatusDate }
              : student
          )
        );
