...
const DefineSubjectsForClassSectionList = () => {
  ...
  const fetchClassSubjects = async () => {
    try {
      ...
      const response = await getAPI(
        `/get-all-class-subjects?schoolId=${schoolId}&academicYear=${academicYear}`
      );
  ...
  const navigateToAdd = (event) => {
    ...
    navigate(
      `/school-dashboard/operational-service/entrance-management/subject-define-list/define-subjects`
    );
  };
  ...
  const navigateToView = (event, record) => {
    event.preventDefault();
    navigate(
      `/school-dashboard/operational-service/entrance-management/subject-define-list/view-define-subjects`,
      { state: record }
    );
  };
  ...
  const navigateToUpdate = (event, record) => {
    event.preventDefault();
    navigate(
      `/school-dashboard/operational-service/entrance-management/subject-define-list/update-define-subjects`,
      { state: record }
    );
  };
...
export default DefineSubjectsForClassSectionList;
