...
const UpdateSubjectsForClassSection = () => {
  //   const navigate = useNavigate();
  //   const location = useLocation();
  //   const record = location.state; // ✅ get the record passed from list page
  ...
  //     setSubjectRows((prev) => [
  //       ...prev,
  //       { id: Date.now(), subjectName: "", isNew: true }, // mark as new
  //     ]);
  //   };
  ...
  // const handleDeleteConfirmed = (deletedSubjectId) => {
  ...
  //           ? `/update-or-add-subject/${record._id}`
  //           : `/update-or-add-subject/${record._id}/${subject.id}`;
...
export default UpdateSubjectsForClassSection;
