...
//         navigate(
//           `/school-dashboard/operational-service/sms/attandance-sms/templates/create`
//         );
//       };
...
// export default AbsentTemplateList
  ...
  const fetchTemplates = async () => {
    try {
      const res = await getAPI(
        `/get-absentsms-template?schoolId=${schoolId}&academicYear=${academicYear}`
      );
