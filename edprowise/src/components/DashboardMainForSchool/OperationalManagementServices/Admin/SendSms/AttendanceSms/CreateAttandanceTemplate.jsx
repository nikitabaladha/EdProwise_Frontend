...
// const CreateAttandanceTemplate = () => {
...
// export default CreateAttandanceTemplate
...
const CreateAttandanceTemplate = () => {
  ...
  const { schoolsId, academicYear } = location.state || {};
console.log("schoolsId", schoolsId);
  ...
  const studentTags = [
    ...
    { tag: "{date}", description: "Todays Date" },
  ];
