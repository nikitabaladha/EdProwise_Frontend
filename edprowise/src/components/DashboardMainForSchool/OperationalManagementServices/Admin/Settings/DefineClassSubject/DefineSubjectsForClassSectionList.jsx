...
const DefineSubjectsForClassSectionList = () => {
  ...
  const navigateToAdd = (event) => {
    ...
    navigate(
      `/school-dashboard/operational-service/setting/subject-define-list/define-subjects`
    );
  };
  ...
  const navigateToView = (event, record) => {
    event.preventDefault();
    navigate(
      `/school-dashboard/operational-service/setting/subject-define-list/view-define-subjects`,
      { state: record }
    );
  };
  ...
  const navigateToUpdate = (event, record) => {
    event.preventDefault();
    navigate(
      `/school-dashboard/operational-service/setting/subject-define-list/update-define-subjects`,
      { state: record }
    );
  };
