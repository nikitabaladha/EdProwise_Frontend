...
const AbsentStudentAttendanceClassReportList = () => {
  ...
  const navigateToView = (event, record) => {
    ...
    navigate(
      `/school-dashboard/operational-service/student-attendance/student-absent-report/view-report`,
       {
        state: {
...
export default AbsentStudentAttendanceClassReportList;
