...
const LateStudentAttendanceClassReportList = () => {
  ...
  const navigateToView = (event, record) => {
    ...
    navigate(
      `/school-dashboard/operational-service/student-attendance/student-late-arrival-report/view-report`,
      {
        state: {
...
export default LateStudentAttendanceClassReportList;
