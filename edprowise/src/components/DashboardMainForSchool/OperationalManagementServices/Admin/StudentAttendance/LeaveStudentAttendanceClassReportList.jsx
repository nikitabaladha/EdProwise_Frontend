...
const LeaveStudentAttendanceClassReportList = () => {
  ...
  const navigateToView = (event, record) => {
    ...
    navigate(
      `/school-dashboard/operational-service/student-attendance/student-leave-report/view-report`,
      {
        state: {
...
export default LeaveStudentAttendanceClassReportList;
