...
// const StudentAttendanceClassList = () => {
...
//         `/get-student-attendance-school?date=${attendanceDate}`
//       );
...
//     navigate(
//       `/school-dashboard/operational-service/student-attendance/digital-student-attendance/take-attendance`,
...
//     event.preventDefault();
//     navigate(
//       `/school-dashboard/operational-service/student-attendance/digital-student-attendance/view-attendance`,
//       { state: record }
//     );
//   };
...
//     event.preventDefault();
//     navigate(
//       `/school-dashboard/operational-service/student-attendance/digital-student-attendance/update-attendance`,
//       { state: record }
//     );
//   };
...
// export default StudentAttendanceClassList;
...
const StudentAttendanceClassList = () => {
  ...
  //   navigate(
  //     `/school-dashboard/operational-service/student-attendance/digital-student-attendance/update-attendance`,
  //     { state: record, attendanceDate }
  //   );
  // };

  const navigateToUpdate = (event, record, attendanceDate) => {
    event.preventDefault();
    navigate(
      `/school-dashboard/operational-service/student-attendance/digital-student-attendance/update-attendance`,
      {
                ...
                <table className="table align-middle mb-0 table-hover table-centered text-center">
                  <thead className="bg-light-subtle">
                    <tr className="payroll-table-header">
                      ...
                      <th className="text-nowrap">Class</th>
                      <th className="text-nowrap">Section</th>
                      {/* <th className="text-nowrap">Total Students</th> */}
                      <th className="text-nowrap">Action</th>
                    </tr>
                  </thead>
                  <tbody>
                    {loading ? (
                      ...
                      attendanceRecords.map((record, index) => (
                        <tr key={index}>
                          ...
                          {/* <td>{record.students?.length || 0}</td> */}
                          <td className="text-center">
                            <div className="d-flex gap-2 justify-content-center">
                              <Link
                                className="btn btn-light btn-sm"
