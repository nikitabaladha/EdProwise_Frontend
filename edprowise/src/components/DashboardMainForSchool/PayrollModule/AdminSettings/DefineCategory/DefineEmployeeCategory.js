...
const [isDeleteDialogOpen, setIsDeleteDialogOpen] = useState(false);
  ...
  const fetchData = async (schoolId, year) => {
    try {
      const res = await getAPI(`/getall-employee-category/${schoolId}?academicYear=${year}`, {}, true);
  ...
  const handleSave = async (id, name, isNew) => {
    ...
    try {
      if (isNew) {
        ...
        const res = await postAPI("/create-employee-category", payload, {}, true);
        ...
        const res = await putAPI(`/update-employee-category/${id}`, payload, {}, true);
        console.log("response", res);
    ...
    setDeleteType("employeeCategory");
...
export default DefineEmployeeCategory;
