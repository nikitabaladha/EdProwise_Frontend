...
const EmployeeRegistrationList = () => {
    ...
    const navigateToRegisterEmployee = (event) => {
        ...
        navigate(`/school-dashboard/payroll-module/admin-setting/registration-form`);
      };

      const navigateToRegisterInfo = (event, employee) => {
        event.preventDefault();
    navigate(`/school-dashboard/payroll-module/admin-setting/view-registration-form`, {
    //   state: { employee },
    });      };

      const navigateToUpdateRegisterInfo = (event, employee) => {
        event.preventDefault();
       navigate(`/school-dashboard/payroll-module/admin-setting/update-registration-form`, {
    //   state: { employee },
    });
      };
