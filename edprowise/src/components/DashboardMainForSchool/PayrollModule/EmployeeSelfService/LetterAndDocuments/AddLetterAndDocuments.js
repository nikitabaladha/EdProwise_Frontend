...
const AddLetterAndDocuments = () => {
    const navigate = useNavigate();
        ...
        const handleAddRow = () => {
            setAchievements([...achievements, { title: '', certificate: null, description: '' }]);
        };
                                    ...
                                    <div key={index} className="border p-2 mb-3 rounded">
                                        {index !== 0 && (
                                            <div className="text-end p-0 mb-2">
                                                <Link className="btn btn-soft-danger text-end btn-sm"
                                        ...
                                        <div className="row mt-2">
                                            <div className="col-md-6">
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        handleChange(index, 'certificate', e.target.files[0])
                                                    }
                                                />
                                            </div>
                                        </div>
...
export default AddLetterAndDocuments