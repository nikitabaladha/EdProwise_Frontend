...
const ViewPromotionNominationDetail = () => {
                        ...
                        <div className="card-body custom-heading-padding">
                            <div className="container">
                                <div className="card-header d-flex  align-items-center">
                                    <h4 className="payroll-title text-center mb-0 flex-grow-1">Employee Promotion Details</h4>
                                </div>
                            </div>
...
export default ViewPromotionNominationDetail