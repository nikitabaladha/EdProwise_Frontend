...
const RequestQuote = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "productImages") {
      // Convert FileList to array and take first (4 - current images) images
      ...
      setFormData((prev) => ({
        ...prev,
        productImages: [...prev.productImages, ...newImages].slice(0, 4), // Ensure we don't exceed 4 images
      }));
    } else {
                  ...
                  <div className="col-md-6">
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        multiple
                        disabled={formData.productImages.length >= 4} // Disable when max reached
                      />
