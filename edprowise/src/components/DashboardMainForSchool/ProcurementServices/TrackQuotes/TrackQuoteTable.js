...
//                             {/* here i want to show by default 1st image*/}
//                             <td>
//                               <div className="d-flex align-items-center gap-2">
//                                 {quote?.productImages &&
//                                   quote?.productImages?.length > 0 && (
//                                     <div className="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
//                                       <img
//                                         className="avatar-md"
//                                         alt={quote?.subCategoryName}
//                                         src={imageUrl}
//                                         // src={`${process.env.REACT_APP_API_URL_FOR_IMAGE}${quote?.productImages[0]}`}
//                                         // onClick={() =>
//                                         //   handleImageClick(
//                                         //     `${process.env.REACT_APP_API_URL_FOR_IMAGE}${quote?.productImages[0]}`
//                                         //   )
//                                         // }
//                                         onClick={() =>
