...
const StudentNotes = () => {
  ...
  const navigateToAdd = (event) => {
    ...
    navigate(`/student-dashboard/notes-notice/notes/add-note`);
  };

  const navigateToView = (event) => {
    event.preventDefault();
    navigate(`/student-dashboard/notes-notice/notes/view-note`);
  };

  const navigateToUpdate = (event) => {
    event.preventDefault();
    navigate(`/student-dashboard/notes-notice/notes/update-note`);
  };
