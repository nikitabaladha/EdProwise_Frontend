...
const TeacherResignationForm = () => {
    ...
    const reasonForLeaving = [
        ...
        { label: 'Performance below expectation', value: 'Performance below expectation  ' },
                                ...
                                <div className="row">
                                    ...
                                    <div className="row">
                                        <div className="py-2 d-flex justify-content-start align-items-start gap-1">
                                            <div className="form-check ms-1" style={{marginTop:" 0.250rem"}}>
                                                <input
                                                    type="checkbox"
                                                    className="form-check-input"
                                                    id="checkDeclaration"
                                            ...
                                            <div>
                                                <p className="mb-0 fw-bold text-dark ps-2" style={{ fontSize: "1rem" }}>I accept and agree to comply with the school policies and will ensure to complete all the exit formalities outlined by the school by my last working day. In case i fail to comply, I authorize the school to make necessary deductions from my Full & Final payment as per the prevailing penalty outlined in the policy.
                                                </p>
                                                <p className="mb-0 fw-bold text-dark ps-2" style={{ fontSize: "1rem" }}>I have read and understood the Exit Policy. I agree to comply with the same. </p>
                                            </div>
                                        </div>
                                    </div>
...
export default TeacherResignationForm;