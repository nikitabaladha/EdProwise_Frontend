...
const TeacherResignationList = () => {

      const navigate = useNavigate();
      const navigateToAdd = (event) => {
        event.preventDefault();
        navigate(`/teacher-dashboard/resignation/add-resignation`);
      };
    
      const navigateToView = (event) => {
        event.preventDefault();
        navigate(
          `/teacher-dashboard/resignation/view-resignation`
        );
      };
    
      const navigateToUpdate = (event) => {
        event.preventDefault();
        navigate(`/teacher-dashboard/resignation/update-resignation`);
      };
...
export default TeacherResignationList 