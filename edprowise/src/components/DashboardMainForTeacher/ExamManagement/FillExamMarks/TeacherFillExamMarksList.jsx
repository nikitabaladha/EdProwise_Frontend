...
const TeacherFillExamMarksList = () => {
  const navigate = useNavigate();
  const navigateToView = (event) => {
    event.preventDefault();
    navigate(`/teacher-dashboard/exam/exam-marks-list/view-fill-marks`);
  };

  const navigateToFill = (event) => {
    event.preventDefault();
    navigate(`/teacher-dashboard/exam/exam-marks-list/fill-marks`);
  };

  const navigateToUpdate = (event) => {
    event.preventDefault();
    navigate(`/teacher-dashboard/exam/exam-marks-list/update-fill-marks`);
  };
                ...
                <table className="table align-middle mb-0 table-hover table-centered text-center">
                  <thead className="bg-light-subtle">
                    <tr className="payroll-table-header">
                      ...
                      <th className="text-nowrap">Student Attend</th>
                    ...
                    <tr>
                      ...
                      <td className="text-center">
                        <div className="d-flex gap-2 justify-content-center">
                          ...
                          >
                            <AiFillFileAdd className="align-middle fs-18" />
                          </Link>
...
export default TeacherFillExamMarksList;