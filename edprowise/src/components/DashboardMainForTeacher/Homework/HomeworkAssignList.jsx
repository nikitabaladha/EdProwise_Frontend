...
const HomeworkAssignList = () => {
  const navigate = useNavigate();

  const navigateToAdd = (event) => {
    event.preventDefault();
    navigate(
      `/teacher-dashboard/homework/homework-assign-list/assign-homework`
    );
  };
  ...
  const navigateToUpdate = (event) => {
    event.preventDefault();
    navigate(
      `/teacher-dashboard/homework/homework-assign-list/update-assign-homework`
    );
  };
  ...
  const navigateToView = (event) => {
    event.preventDefault();
    navigate(
      `/teacher-dashboard/homework/homework-assign-list/view-assign-homework`
    );
  };
            ...
            <div className="card-body custom-heading-padding">
              <div className="container">
                <div className="card-header d-flex flex-wrap align-items-center">
                  ...
                  <FaRegCalendarAlt className="fs-18 me-2" />
...
export default HomeworkAssignList;
