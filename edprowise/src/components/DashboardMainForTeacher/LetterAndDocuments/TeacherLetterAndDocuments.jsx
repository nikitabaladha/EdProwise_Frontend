...
const TeacherLetterAndDocuments = () => {
  const navigate = useNavigate();
  const navigateToAdd = (event) => {
    event.preventDefault();
    navigate(
      `/teacher-dashboard/documents/add-documents`
    );
  };

  const navigateToView = (event) => {
    event.preventDefault();
    navigate(`/teacher-dashboard/documents/view-documents`);
  };

  const navigateToUpdate = (event) => {
    event.preventDefault();
    navigate(`/teacher-dashboard/documents/update-documents`);
  };
...
export default TeacherLetterAndDocuments;