...
const TeacherNotices = () => {
  ...
  const navigateToAdd = (event) => {
    ...
    navigate(`/teacher-dashboard/notes-notice/notices/add-notice`);
  };

  const navigateToView = (event) => {
    event.preventDefault();
    navigate(`/teacher-dashboard/notes-notice/notices/view-notice`);
  };

  const navigateToUpdate = (event) => {
    event.preventDefault();
    navigate(`/teacher-dashboard/notes-notice/notices/update-notice`);
  };
