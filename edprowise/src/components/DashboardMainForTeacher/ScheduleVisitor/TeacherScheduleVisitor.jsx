...
const TeacherScheduleVisitor = () => {
  const navigate = useNavigate();

  const navigateToApply = (event) => {
    event.preventDefault();
    navigate(`/teacher-dashboard/visiting-schedule/apply-visiting`);
  };

  const navigateToView = (event) => {
    event.preventDefault();
    navigate(`/teacher-dashboard/visiting-schedule/view-visit-details`);
  };

  const navigateToUpdate = (event) => {
    event.preventDefault();
    navigate(`/teacher-dashboard/visiting-schedule/update-visit-details`);
  }; 
  return (
...
export default TeacherScheduleVisitor;