...
const TeacherLeaveList = () => {
  ...
  const navigateToAdd = (event) => {
    ...
    navigate(`/teacher-dashboard/attendance-leave/leave-record/apply-leave`);
  };

  const navigateToView = (event) => {
    event.preventDefault();
    navigate(
      `/teacher-dashboard/attendance-leave/leave-record/view-leave-details`
    );
  };
  ...
  const navigateToUpdate = (event) => {
    event.preventDefault();
    navigate(
      `/teacher-dashboard/attendance-leave/leave-record/update-leave-details`
    );
  };
