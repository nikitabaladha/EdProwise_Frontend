...
const coursesData = [
  ...
  },
  {
    ...
    link: "/services/academic-admin-services",
  },
  {
    id: 3,
    icon: <FaSchool />,
    title: "Orbit School ",
    description:
      "A complete digital transformation ecosystem for modern schools - Smart Learning, STEM Labs, AI Tools, ERP, Branding & more.",
    link: "https://orbitschool.edprowise.com",
    external: true,
  },
  {
    id: 4,
