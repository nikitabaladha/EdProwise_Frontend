...
const HomeMainSection = () => {
  ...
  const serviceData = [
    ...
    { title: "Digital Student Attendance", send:"" },
    { title: "Digital Staff Attendance", send:"" },
    { title: "Library Management Software", send:"" },
    {title:"Entrance Management Software", send:""},
    {title:"Online Payment Gateway", send:""},
    {title:"SMS & WhatsApp Integration Services", send:""},
    {title:"", send:""},
    {title:"", send:""},
    {title:"", send:""},
    {title:"", send:""},
