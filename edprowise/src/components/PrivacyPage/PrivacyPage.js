            ...
            <div className="col-lg-10 offset-lg-1">
              <div className="wpo-terms-wrap">
                ...
                <div className="wpo-terms-text">
                  ...
                  <p className="text-black">The purpose of this policy is to present Edprowise Tech Pvt Ltd (herein referred to as the Company) commitment to the privacy of user information and sensitive commercial/financial data.
                  </p>
                  {/* <p>
                  ...
                  <p className="text-black">This policy applies to all data that is either owned or managed by the Company. This is in accordance with the ISO27001: 2022 & CSA STAR controls.
                  </p>
                  ...
                  <p className="text-black">
                    Edprowise Tech Pvt. Ltd.  (“Company”, "We", "Us", or "Our"), a private limited company which owns and operates the website https://www.edprowise.com/ is committed to protecting Your privacy and the information that You share while using the Platform. We value the trust you place in us. That’s why we maintain the highest security standards for securing the transactions and your information.
                  </p>
                  <p className="text-black">
                  ...
                  <ol>
                    ...
                    <p className="text-black">You agree and acknowledge that all information gathered from you may be used by us and/or authorized third parties/entities for the following purposes:</p>
                      <ul>
                        <li className="text-black">
                        To provide, maintain, develop, protect, and improve the Platform and for developing new products and services.
                        </li>
                        <li className="text-black">
                        To evaluate Your credit profile and creditworthiness.
                        </li>
                        <li className="text-black">
                        To facilitate Your KYC and enable You to open an Account with Us.
                        </li>
                        <li className="text-black">
                        To verify Your identity, eligibility, and registration as a user on the Platform.
                        </li>
                        <li className="text-black">
                        To complete the transaction initiated by You.
                        </li>
                        <li className="text-black">
                        To address Your requests, queries, and complaints, if any.
                        </li>
                        <li className="text-black">
                        To keep You informed about the transaction status.
                        </li>
                        <li className="text-black">
                        To inform You about new products or services that may be of interest to You.
                        </li>
                        <li className="text-black">
                        To inform You about changes in any features and functionalities of the Platform.
                        </li>
                        <li className="text-black">
                        To evaluate and administer Your Application and Our services provided through the Platform.
                        </li>
                        <li className="text-black">
                        To improve, customize, and personalize Our services provided to You.
                        </li>
                        <li className="text-black">
                        To analyse and evaluate your behaviour on the Platform.
                        </li>
                        <li className="text-black">
                        To ensure that the content on the Platform is presented in the most effective manner for You and for Your computer or mobile device.
                        </li>
                        <li className="text-black">
                        To prevent fraud, unauthorized transactions, money laundering, and other illegal activities and protect You, other users, and Us.
                        </li>
                        <li className="text-black">
                        To ensure compliance with legal and regulatory requirements and to handle legal disputes, if any.
                        </li>
                        <li className="text-black">
                        To determine Your experience with Our products and services that are offered on the Platform.
                        </li>
                        <li className="text-black">
                        To allow Us to analyse, research, and innovate for enhancing user experience and overall quality of Our services.
                        </li>
                        <li className="text-black">
                        To generate and review reports and data about, and to conduct research on, Our user base and Service usage patterns.
                        </li>
                        <li className="text-black">
                        To contact You via email, phone, or otherwise for marketing and promotional purposes.
                        </li>
                        <li className="text-black">
                        To contact You to provide You with information that may be of interest to You, including information about products, services, promotions, news, and events of the Company.
                        </li>
                      </ul>

                      <li className="policy-act">Sharing Of Information</li>
                      <p className="text-black">You hereby expressly provide us with your consent to share Your Personal Information with third parties, only in such manner as provided below:</p>
                      <ul>
                        <li className="text-black">
                        With Service Providers: We may share Your Personal Information with the service providers, including any vendor or any third-party service providers who perform any functions on Our behalf, pursuant to a contract or otherwise. These service providers or vendors may include without limitation IT service providers, banks, payment gateway service providers, lawyers, auditors, consultants, credit bureaus, and other service providers who enable us to provide services to you.
                        </li>
                        <li className="text-black">
                        ...
                        <li className="text-black" >
                        With Financial Institutions: We may share Your Personal Information with financial institutions, including but not limited to, banks, non-banking financial companies (NBFCs), and other financial institutions who are Our partners and who may offer financial products and services through the Platform, for the purpose of evaluating and processing Your credit profile and creditworthiness, and for facilitating transactions on the Platform.
                        </li>
                        <li className="text-black">
                        ...
                        <li className="text-black">
                        With Prospective Buyers: We may share Your Personal Information with prospective buyers of the Company or its assets, in case of any merger, acquisition, or sale of the Company or its assets, in whole or in part, subject to compliance with applicable laws.
                        </li>
                        <li className="text-black">
                        With Your Consent: We may share Your Personal Information with third parties when You have provided Your express consent for such sharing.
                        </li>
                      </ul>
                      ...
                      <p className="text-black">We use reasonable technical and organizational measures to protect the Personal Information that we collect, store, and process. We also ensure that our service providers use appropriate security measures to protect Your Personal Information. However, we cannot guarantee the absolute security of Your Personal Information, and you agree that we will not be liable for any unauthorized access or use of Your Personal Information by third parties.</p>
                       ...
                       <ul>
                        <li className="text-black">
                        Right to Access: You have the right to access and review the Personal Information that we hold about you. You may request us to provide you with a copy of Your Personal Information, subject to applicable laws and regulatory requirements.
                        </li>
                        <li className="text-black">
                        ...
                        <li className="text-black">
                        Right to Erasure: You have the right to request the deletion of Your Personal Information, subject to applicable laws and regulatory requirements. However, we may retain certain information as required by applicable laws, regulatory requirements, or for legitimate business purposes.
                        </li>
                        <li className="text-black">
                        Right to Restrict Processing: You have the right to request the restriction of the processing of Your Personal Information under certain circumstances, subject to applicable laws and regulatory requirements.
                        </li>
                        <li className="text-black">
                        Right to Object: You have the right to object to the processing of Your Personal Information, subject to applicable laws and regulatory requirements.
                        </li>
                        <li className="text-black">
                        Right to Data Portability: You have the right to request the transfer of Your Personal Information to another data controller, subject to applicable laws and regulatory requirements.
                        </li>
                       </ul>

                       <li className="policy-act">
                        Changes To The Privacy Policy</li>
                       <p className="text-black">We reserve the right to update or modify this Privacy Policy at any time, without prior notice. Any changes to this Privacy Policy will be posted on the Platform. Your continued use of the Platform following the posting of changes to this Privacy Policy constitutes your acceptance of those changes. </p>
                      ...
                      <p className="text-black">By using the Platform and providing Your Personal Information, You acknowledge that you have read, understood, and agree to be bound by this Privacy Policy.</p>
                  </ol>
                </div>
