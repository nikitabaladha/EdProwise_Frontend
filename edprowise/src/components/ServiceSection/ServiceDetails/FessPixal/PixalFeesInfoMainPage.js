 ...
 const PixalFeesInfoMainPage = () => {
    const [counter, setCounter] = useState(0);
      ...
      const courses = [
        ...
        {
            id: "4",
            icon: "Accurate Fees With",
            title: "Zero",
            serviceid: "Leakage promise"
          },
          {
            id: "5",
            icon: "Compliance Simplified",
            title: "Audits",
            serviceid: "Made Easy"
          },
          {
            id: "6",
            icon: "Authorized Concessions",
            title: "Smooth",
            serviceid: "Operations"
          },
          {
          ...
          <div className="container-fluid home-hero-container-fluid">
            <div className="hero-content" style={{order:"2"}}>
              ...
              <div data-swiper-parallax="400" className="slide-text">
                ...
                Simplifies fees management ,process, ensuring accuracy,in fees collection, tracking & reporting, Including Fees Reconciliation
                </p>
              </div>
            ...
            <div className="student-pic home-hero-student-pic service-subpage-image">
              <img src="/assets/website-images/event/Pixel Fees.png" alt="Student" />
...
export default PixalFeesInfoMainPage;
