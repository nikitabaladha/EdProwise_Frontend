...
const PayrollInfoMainPage = () => {
     const [counter, setCounter] = useState(0);
              ...
              const courses = [
                ...
                {
                  id: "2",
                  icon: "Salary Simplified",
                  title: "Hiring",
                  serviceid: "Streamlined"
                },
                {
                  id: "3",
                  icon: "Smart Attendance",
                  title: "Seamless",
                  serviceid: "Payroll"
                },
                {
                    id: "4",
                    icon: "Salary Automation",
                    title: "Maximum",
                  ...
                  {
                    id: "6",
                    icon: "Payroll & Finance",
                    title: "Perfectly",
                    serviceid: " Aligned"
                  },
                  {
                    id: "7",
                    icon: "Transparent Salaries Slips",
                    title: "Happy",
                    serviceid: " Employees"
                  },
              ];
              ...
              <div className="container-fluid home-hero-container-fluid ">
                <div className="hero-content" style={{order:"2"}}>
                  ...
                  <div data-swiper-parallax="400" className="slide-text">
                    ...
                    Streamline payroll process to ensure timely & accurate payment of salaries, adhering to regulatory requirement.
                    </p>
                  </div>
                ...
                <div className="student-pic home-hero-student-pic service-subpage-image">
                  <img src="/assets/website-images/event/Ease Payroll.png" alt="Student" />
...
export default PayrollInfoMainPage;
