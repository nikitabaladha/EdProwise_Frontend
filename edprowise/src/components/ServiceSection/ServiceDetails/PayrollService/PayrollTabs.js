...
<section className="wpo-courses-section-s2 section-padding pt-0">
              ...
              <div className="category-wrapper">
                <div className="category-nav">
                  ...
                  >
                    ...
                    <button id="keyFeaturesSection" className={`category-item-btn   ${activeTab === "keyFeaturesSection" ? "active" : ""}`}
                      onClick={() => showTab("keyFeaturesSection")}> Key Features</button>

                    <button id="reportSection" className={`category-item-btn   ${activeTab === "reportSection" ? "active" : ""}`}
                      onClick={() => showTab("reportSection")}>Report</button>

                    <button id="FAQSection" className={`category-item-btn   ${activeTab === "FAQSection" ? "active" : ""}`}
                      onClick={() => showTab("FAQSection")}>FAQ</button>

                    <button id="whatSolvingSection" className={`category-item-btn  ${activeTab === "whatSolvingSection" ? "active" : ""}`}
                      onClick={() => showTab("whatSolvingSection")} > What We Are Solving</button>

                    <button id="brochureSection" className="download-brocher-tab" onClick={() => handleDownload("brochureSection")}
        ...
        <div className="container section-padding pt-lg-5">
          <div className={`show-tab ${activeTab === "keyFeaturesSection" ? "active" : ""}`} id="keyFeaturesSection">
          <PayrollKeyFeacher />
          </div>

          <div className={`show-tab ${activeTab === "reportSection" ? "active" : ""}`} id="reportSection">
          <PayrollReport />
          </div>

          <div className={`show-tab ${activeTab === "FAQSection" ? "active" : ""}`} id="FAQSection">
          <EasePayrollFAQSection />
          </div>

          <div className={`show-tab ${activeTab === "whatSolvingSection" ? "active" : ""}`} id="whatSolvingSection">
          <WhatWeSolvePayroll />
          </div>
        </div>
      </section>
