...
const SchoolApplicationKeyFeature = () => {
    ...
    const chooseDataPrinciple = [
      {
        ...
        description:
         "Alerts for fee collection updates and reminders.",
        classNameS: "s1",
      },
      {
        id: 2,
      ...
      },
      {
        ...
        description:
          "View and manage student attendance, including absences.",
        classNameS: "s3",
      },
      {
        id: 7,
    ...
    const chooseDataTeacher = [
      {
        ...
        description:
          "Mark student attendance and track absenteeism.",
        classNameS: "s1",
      },
      {
        id: 2,
        ...
        description:
          "View and manage teaching schedules and room assignments.",
        classNameS: "s2",
      },
      {
        id: 3,
        title: "Self Notes (My Notes)",
        description:
          " Keep track of personal notes, reminders, and tasks.",
        classNameS: "s3",
      },
      {
        id: 4,
      ...
      },
      {
        ...
        description:
          "Access exam schedules and related details.",
        classNameS: "s1",
      },
      {
        id: 6,
      ...
      },
      {
        ...
        description:
          "Access and view salary details and payment history.",
        classNameS: "s3",
      },
      {
        id: 8,
      ...
      },
      {
        ...
        title: "Form 16",
        description:
          "Access the Form 16 for tax purposes.",
        classNameS: "s1",
      },
      {
        id: 10,
        ...
        description:
          "View loan details and repayment status.",
        classNameS: "s2",
      },
      {
        id: 11,
        ...
        description:
          "View personal attendance and leave records.",
        classNameS: "s3",
      },
      {
        id: 12,
      ...
      },
      {
        ...
        description:
          "Upload assignments, track submissions, and grade homework.",
        classNameS: "s2",
      },
      {
        id: 15,
      ...
      },
      {
        ...
        description:
         "Input and manage exam results for students.",
        classNameS: "s4",
      },
      {
        id: 17,
    ...
    const chooseDataStudent = [
      {
        ...
        title: "Fee Payment",
        description:
          "Pay school fees securely and track payment history.",
        classNameS: "s1",
      },
      {
        id: 2,
        ...
        description:
          "View academic progress, exam results, and report cards.",
        classNameS: "s2",
      },
      {
        id: 3,
        ...
        description:
          "Track attendance and stay updated on any absences.",
        classNameS: "s3",
      },
      {
        id: 4,
        ...
        description:
         "View class schedules, assignments, and homework deadlines.",
        classNameS: "s4",
      },
      {
        id: 5,
        title: "Exam Timetable",
        description:
          "Access exam schedules and preparation details.",
        classNameS: "s1",
      },
      {
        id: 6,
  ...
  return (
    <>
    <section
    className="wpo-courses-section-s2 section-padding pt-0 pb-0"
