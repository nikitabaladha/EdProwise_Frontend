...
const ServiceMainSection = () => {
  ...
  return (
          ...
          <div className="category-wrapper">
            <div className="category-nav">
              ...
              >
                ...
                <button id="digitalSection" className={`category-item-btn   ${activeTab === "digitalSection" ? "active" : ""}`}
                  onClick={() => showTab("digitalSection")}> Digital Services</button>
                ...
                <button id="recruitmentSection" className={`category-item-btn  ${activeTab === "recruitmentSection" ? "active" : ""}`}
                  onClick={() => showTab("recruitmentSection")} > Hire School Teacher</button>
              </div>
              {/* <button
    ...
    <div className="container section-padding pt-lg-5 pb-1">
      <div className={`show-tab ${activeTab === "digitalSection" ? "active" : ""}`} id="digitalSection">
        {/* <EdProwiseFAQSection /> */}
        <DigitalSection />
      </div>

      <div className={`show-tab ${activeTab === "businessSection" ? "active" : ""}`} id="businessSection">
      <BusinessSection />
      </div>

      <div className={`show-tab ${activeTab === "procurementSection" ? "active" : ""}`} id="procurementSection">
      <ProcurementSection />
      </div>
