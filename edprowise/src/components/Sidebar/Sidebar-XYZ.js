...
const Sidebar = () => {
  ...
  return (
    // {/* i want that when small screen i want to hide this main nav  and show the button to the header from that button user can again view the sidebar and if want again hide  */}
