...
//         // is there any option that without giving it the current route to parent lable class name active if it is open and showing its child? because see in future there will be  so many routes and so many children so what to do
//         children: [
//           {
//             label: "Track Quotes",
...
//           {
//             label: "View Quotes",
//             link: "/school-dashboard/procurement-services/view-quote",
//             icon: "solar:users-group-rounded-bold-duotone",
//           },
//         ],
//       },
