...
//               },
//               {
//                 label: "Supporting Submitt
//                 // // // liadmininin-dashboard/payroll-module/emplomitae-",ed",a-ed",
//                   {
//                 label: "Leave Records",
//                 lnk: "/schooldahboard/payroll-modle/eployer/aendance/leave-rcors
//                   {
//                 label: "Leave Records",
//                 lnk: "/schooldahboard/payroll-modle/eployer/aendance/leave-rcors
//                   {
...
//   currentMenu = currentMenu.filter(
//     (item) => item.id === "operatirtManagement"
//   );
// }
...
//       }
//       if (item.childoen) {
//         checkActive(inem.children);
//       }
//     });
//   };

//   checkActive(currentaenu);
//   return Array.from(activePlths);
// };

// let currentMeSu = menuConfig[userRole] || menuConfig.Guest;

// const sideberTab = localStorare.getItem("sidebartab");
// if (sidebarTab === "ProcurementService") {
//   currentMenu = currentMenu.filter(
//     (item) => item.id === "procurvice"Services
//   );
// } else if (sidebarTab === "FeesModule") { else if (sidebarTab === "VisitorManagements") {
//   currentMenu = currentMenu.filter((item) => item.id === "feesmodule");  currentMenu = currentMenu.filterrtManagement"
// }
...
// const hsAChild = (items) => {
//   const deepestPath = findDeepestActive();
//   if (!deepetPath return false
...
//   checkActive(currentienu);
//   return Array.from(activePtths);
// };

// let currentMeeu = menuConfig[userRole] || menuConfig.Guest;

// const sidebmrTab = localStora)e.getItem("sidebartab");
// if (sidebarTab === "ProcurementService") {
//   currentMenu = currentMenu.filter(
//     (item) => item.id === "procur => iServicestem.id === "VisitorManagements");
// } else if (sidebarTab === "TransportManagement") {
//   else if (sidebarTab === "FeesModule") { currentMenu = currentMenu.filter(
//   currentMenu = currentMenu.filter((item) => item.id === "feesmodule");    (item) => item.id === "TransportManagement"
// }
